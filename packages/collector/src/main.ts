...
async function main(): Promise<void> {
  ...
  log.info({ network: cfg.network, chainId: cfg.chainId, rpcs: cfg.rpcUrls.map(redactUrl), startBlock: cfg.startBlock, concurrency: cfg.concurrency, batchBlocks: cfg.batchBlocks }, "arc-rail collector starting");

/**
 * The market page: what is for sale on Arc, and a field to add an endpoint. The page writes
 * nothing about a listing: every cell comes from the API, which read it from the endpoint.
 */
